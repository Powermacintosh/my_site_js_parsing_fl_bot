...
def refind_name_m(s):
	s1 = s.split(',')[0]
	s2 = s1.split(' ')[1]
	m1 = s2.replace('января', '01')
	m2 = m1.replace('февраля', '02')
	m3 = m2.replace('марта', '03')
	m4 = m3.replace('апреля', '04')
	m5 = m4.replace('мая', '05')
	m6 = m5.replace('июня', '06')
	m7 = m6.replace('июля', '07')
	m8 = m7.replace('августа', '08')
	m9 = m8.replace('сентября', '09')
	m10 = m9.replace('октября', '10')
	m11 = m10.replace('ноября', '11')
	return m11.replace('декабря', '12')
